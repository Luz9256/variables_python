...
Nombre_padre = str(input('Ingrese nombre y apellido de su padre:'))
Nombre_madre = str(input('Ingrese nombre y apellido de su madre:')) 
Nombre_usuario = str(input('Ingrese sólo su nombre:'))

Nombre_padre, apellido_padre = Nombre_padre.split(' ')
Nombre_madre, apellido_madre = Nombre_madre.split(' ')

Nombre_completo_usuario = Nombre_usuario + ' ' + apellido_madre + ' ' + apellido_padre

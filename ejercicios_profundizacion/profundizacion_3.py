...
en_minúscula = nombre_completo.lower()
en_mayúscula = nombre_completo.upper()
capitalizado = nombre_completo.capitalize()

print(f'Nombre completo: {nombre_completo}')
print(f'Nombre completo en minúsculas: {en_minúscula}')
print(f'Nombre completo en mayúsculas: {en_mayúscula}')
print(f'Nombre completo con primera letra en mayúscula: {capitalizado}')
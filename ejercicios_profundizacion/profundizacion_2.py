...
nombre_apellido = str(input('Ingrese su nombre y su apellido:'))
DNI = int(input('Ingrese su número de DNI:'))
edad = int(input('Ingrese su edad:'))
altura = float(input('Ingrese su altura:'))

print(f'Nombre completo: {nombre_apellido:} y DNI: {DNI:}')
print(f'Nombre completo: {nombre_apellido:}, Edad: {edad:} años y Altura: {altura:}')